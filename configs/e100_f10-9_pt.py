...
class Net(nn.Module):
    def __init__(self):
        ...
        self.resnext = resnext_101_64x4d.resnext_101_64x4d
        self.resnext.load_state_dict(torch.load('resnext_101_64x4d.pth'))
        self.resnext._modules['10']._modules['1'] = nn.Linear(2048, p_transform["n_labels"]) 
        self.resnext._modules['10']._modules['1'].weight.data.zero_()
