...
spp = partial(lasagne.layers.SpatialPyramidPoolingLayer,
                pool_dims=[4], 
                mode='max', 
                implementation='kaiming') #implementation='fast')
...
def build_objective(model, deterministic=False, epsilon=1.e-7):
    ...
    weight_decay=np.float32(0.00004)
