...
class Net(nn.Module):
    def __init__(self):
        ...
        self.densenet = torchvision.models.DenseNet(num_init_features=64, growth_rate=32, block_config=(6, 12, 24, 16),num_classes=p_transform["n_labels"])
...
class MultiLoss(torch.nn.modules.loss._Loss):
    ...
    def forward(self, input, target):
        ...
        return binary_loss+softmax_loss
