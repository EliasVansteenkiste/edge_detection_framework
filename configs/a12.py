...
def res(lin):
    ...
    l2 = sconv(l, n_base_filter, filter_size=1)
    l2 = nl(bn(l2))
    l2 = sconv(l2, n_base_filter, filter_size=3)
    l2 = nl(bn(l2))

    l3 = sconv(l, n_base_filter, filter_size=1)
    l3 = nl(bn(l3))
    l3 = sconv(l3, n_base_filter, filter_size=3)
    l3 = nl(bn(l3))
    l3 = sconv(l3, n_base_filter, filter_size=3)
    l3 = nl(bn(l3))
    ...
    l = sconv(l, lin.output_shape[1], filter_size=1)
