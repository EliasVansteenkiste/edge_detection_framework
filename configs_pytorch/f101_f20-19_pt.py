...
folds = app.make_stratified_split(no_folds=20)
train_ids = folds[0] + folds[1] + folds[2] + folds[3]+ folds[4] + folds[5] + folds[6]+ folds[7] + folds[8] + folds[9] +\
            folds[10] + folds[11] + folds[12] + folds[13]+ folds[14] + folds[15] + folds[16]+ folds[17] + folds[18] 
valid_ids = folds[19]
all_ids = []
for f in folds:
    all_ids = all_ids + f
